...
import com.ajinkya.linky.dto.CreateTagRequest;
...
public class TagController {
    ...
    @PostMapping
    public ResponseEntity<TagResponse> createTag(@AuthenticationPrincipal User user, @Valid @RequestBody CreateTagRequest request) {
