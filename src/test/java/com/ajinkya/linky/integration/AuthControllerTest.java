...
public class AuthControllerTest extends BaseIntegrationTest {
    ...
    void login_ValidCredentials_ReturnsTokens() throws Exception {
        ...
        mockMvc.perform(post("/api/auth/login")
                ...
                .andExpect(cookie().exists("linky_at"))
                .andExpect(cookie().httpOnly("linky_at", true));
    }
    ...
    void resetPassword_ValidToken_ReturnsOk() throws Exception {
        ...
        prt.setToken(sha256Hex(token)); // PasswordResetService stores only the hash, never the raw token
